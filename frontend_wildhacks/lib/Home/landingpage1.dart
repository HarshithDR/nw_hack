...
class _Landingpage1State extends State<Landingpage1> {
  ...
  Widget build(BuildContext context) {
    ...
    final ButtonStyle originalElevatedButtonStyle = ElevatedButton.styleFrom(
      shape: RoundedRectangleBorder(
        side: BorderSide(width: 3, color: const Color.fromARGB(255, 0, 3, 207)),
        borderRadius: BorderRadius.circular(20),
      ),
      elevation: 10,
      padding: EdgeInsets.all(8), // Kept original padding
      shadowColor: Colors.black,
      backgroundColor: const Color.fromARGB(255, 68, 71, 253),
      foregroundColor: Colors.white, // Added for text color consistency
    );
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0, // Added to ensure transparency consistency
        actions: [
          // --- Log In Button (Original Structure) ---
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: Container(
              // Keeping original Container structure
              ...
              child: ElevatedButton(
                onPressed: () {
                  // Clear previous signup data before showing login if desired
                  // _signupUsernameController.clear(); ... etc.

                  // Clear login fields before showing dialog
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: SingleChildScrollView(
                                          child: Column(
                                            // Original Column for fields
                                            children: [
                                              // --- Login Fields ---
                                              textfielder(
                                                "Username",
                                                _loginUsernameController, // Use state controller
                                                "username",
                                                "Enter your username",
                                              ),
                                              SizedBox(height: 12),
                                              ...
                                              SizedBox(height: 24),
                                              // --- Login Button (Original Structure) ---
                                              GestureDetector(
          ...
          Padding(
            ...
            child: Container(
              ...
              child: ElevatedButton(
                onPressed: () {
                  // Clear fields before showing signup
                  _signupUsernameController.clear();
                  _signupDimensionsController.clear();
                  _signupLocationController.clear();
                  _signupPasswordController.clear();
                  _signupConfirmPasswordController.clear();
                  // Optionally clear login fields too if needed
                  // _loginUsernameController.clear(); ...
                                            ...
                                            children: [
                                              ...
                                              GestureDetector(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Text(
                                                    // Original Text
                                                    'Save', // Text changed back to 'Save' as per original
                                                    style: TextStyle(
                                                      fontSize: 18,
                                                      fontWeight:
                                                          FontWeight.bold,
